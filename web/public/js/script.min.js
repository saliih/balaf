...
!function (t) {
    ...
    t.fn.dropdownHover = function (i) {
        return "ontouchstart" in document ? this : (n = n.add(this.parent()), this.each(function () {
            var o = t(this), r = o.parent(), s = {delay: 500, instantlyCloseOthers: !0},
                a = {delay: t(this).data("delay"), instantlyCloseOthers: t(this).data("close-others")},
                l = t.extend(!0, {}, s, i, a);
    ...
    var v, g = {
            ...
            fixedBackground: !0,
            excluded: ""
        }, b = g, y = !1, w = !1, x = {x: 0, y: 0}, C = !1, k = document.documentElement, T = [120, 120, 120],
        S = {left: 37, up: 38, right: 39, down: 40, spacebar: 32, pageup: 33, pagedown: 34, end: 35, home: 36}, b = g,
        _ = [], E = !1, L = +new Date, I = {};
    ...
    var e, n, i, o, r, s, a = "Close", l = "BeforeClose", c = "AfterClose", d = "BeforeAppend", u = "MarkupParse",
        p = "Open", f = "Change", h = "mfp", m = "." + h, v = "mfp-ready", g = "mfp-removing", b = "mfp-prevent-close",
        y = function () {
                ...
                return e.direction = !0, n && n.enabled ? (r += " mfp-gallery", C(p + o, function () {
                    ...
                    if (e.items.length > 1 && n.arrows && !e.arrowLeft) {
                        var i = n.arrowMarkup,
                            ...
                            r = e.arrowRight = t(i.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(b),
    ...
    10: [function (t, e) {
        ...
        function n(t, e) {
            ...
            e.event.bind(e.scrollbarY, "click", o), e.event.bind(e.scrollbarYRail, "click", function (o) {
                var s = i.toInt(e.scrollbarYHeight / 2), a = o.pageY - n(e.scrollbarYRail).top - s,
                    l = e.containerHeight - e.scrollbarYHeight, c = a / l;
    ...
    17: [function (t, e) {
        "use strict";
        var n = t("../lib/class"), i = t("../lib/helper"), o = t("./instances"), r = t("./update-geometry"),
            s = t("./handler/click-rail"), a = t("./handler/drag-scrollbar"), l = t("./handler/keyboard"),
            c = t("./handler/mouse-wheel"), d = t("./handler/native-scroll"), u = t("./handler/selection"),
            p = t("./handler/touch");
    ...
    18: [function (t, e, n) {
        ...
        var a = t("../lib/dom"), l = t("./default-setting"), c = t("../lib/event-manager"), d = t("../lib/guid"),
            u = t("../lib/helper"), p = {};
        n.add = function (t) {
            var e = d();
    ...
    20: [function (t, e) {
        "use strict";
        var n = t("../lib/dom"), i = t("./destroy"), o = t("./initialize"), r = t("./instances"),
            s = t("./update-geometry");
        e.exports = function (t) {
            var e = r.get(t);
    ...
    if (!t[i]) {
        t[i] = function (t, e, n) {
            ...
            init: function (t) {
                ...
                var o = t(),
                    a = e.add(this.__findAddBack(e, "." + r.listview).children().children(this.conf.panelNodetype)).not("." + r.nopanel);
                ...
                o.each(function () {
                    ...
                    if (!n.is("." + r.menu) && !e.data(s.parent)) {
                        if (n.data(s.sub, e), e.data(s.parent, n), n.parent().is("." + r.listview)) {
                            var o = e.attr("id"),
                                a = t('<a class="' + r.next + '" href="#' + o + '" data-target="#' + o + '" />').insertBefore(i);
    ...
    t[e].addons[n] = {
        setup: function () {
            ...
            if (this.$header = this.$menu.children("." + i.header), r.update && this.$header && this.$header.length) {
                var d = this.$header.find("." + i.title), u = this.$header.find("." + i.prev),
                    p = this.$header.find("." + i.next), f = this.$header.find("." + i.close), h = function (t) {
                        t = t || this.$menu.children("." + i.current);
                        var e = t.find("." + this.conf.classNames[n].panelHeader),
                            s = t.find("." + this.conf.classNames[n].panelPrev),
                            a = t.find("." + this.conf.classNames[n].panelNext), l = t.data(o.parent), c = e.html(),
                            f = s.attr("href"), h = a.attr("href"), m = !1, v = s.html(), g = a.html();
        ...
        setup: function () {
            ...
            a = t[n].glbl, "boolean" == typeof c && (c = {
                ...
                c.search && t("." + o.search, this.$menu).each(function () {
                    var n = t(this);
                    if ("menu" == c.addTo)var i = t("." + o.panel, l.$menu),
                        a = l.$menu; else var i = n.closest("." + o.panel), a = i;
                    var d = n.children("input"), u = l.__findAddBack(i, "." + o.listview).children("li"),
                        p = u.filter("." + o.divider), f = l.__filterListItems(u), h = "> a", m = h + ", > span",
                        v = function () {
            ...
            this.conf[n], s = t[e].glbl, "boolean" == typeof a && (a = {add: a}), "object" != typeof a && (a = {}), a = this.opts[n] = t.extend(!0, {}, t[e].defaults[n], a), this.bind("init", function (e) {
                ...
                if (!this.$indexer && this.$menu.children("." + i.hasindexer).length) {
                    this.$indexer = t('<div class="' + i.indexer + '" />').prependTo(this.$menu).append('<a href="#a">a</a><a href="#b">b</a><a href="#c">c</a><a href="#d">d</a><a href="#e">e</a><a href="#f">f</a><a href="#g">g</a><a href="#h">h</a><a href="#i">i</a><a href="#j">j</a><a href="#k">k</a><a href="#l">l</a><a href="#m">m</a><a href="#n">n</a><a href="#o">o</a><a href="#p">p</a><a href="#q">q</a><a href="#r">r</a><a href="#s">s</a><a href="#t">t</a><a href="#u">u</a><a href="#v">v</a><a href="#w">w</a><a href="#x">x</a><a href="#y">y</a><a href="#z">z</a><a href="##">#</a>'), this.$indexer.children().on(r.mouseover + "-searchfield " + i.touchmove + "-searchfield", function () {
                        var e = t(this).attr("href").slice(1), n = o.$menu.children("." + i.current),
                            r = n.find("." + i.listview), s = !1, a = n.scrollTop(),
                            l = r.position().top + parseInt(r.css("margin-top"), 10) + parseInt(r.css("padding-top"), 10) + a;
        ...
        setup: function () {
            ...
            this.opts[n], this.conf[n], s = t[e].glbl, this.bind("init", function (e) {
                this.__refactorClass(t("input", e), this.conf.classNames[n].toggle, "toggle"), this.__refactorClass(t("input", e), this.conf.classNames[n].check, "check"), t("input." + i.toggle + ", input." + i.check, e).each(function () {
                    var e = t(this), n = e.closest("li"), r = e.hasClass(i.toggle) ? "toggle" : "check",
    ...
    t.flexslider = function (e, n) {
        ...
        var o, r = i.vars.namespace, s = window.navigator && window.navigator.msPointerEnabled && window.MSGesture,
            a = ("ontouchstart" in window || s || window.DocumentTouch && document instanceof DocumentTouch) && i.vars.touch,
            l = "click touchend MSPointerUp keyup", c = "", d = "vertical" === i.vars.direction, u = i.vars.reverse,
            p = i.vars.itemWidth > 0, f = "fade" === i.vars.animation, h = "" !== i.vars.asNavFor, m = {}, v = !0;
    ...
    function n(t) {
        this.el = t, this.inputEl = t.querySelector("input.form-control"), this._initEvents()
    }
    ...
    var r = "stellar", s = {
        ...
        }(), d = c("transform"), u = t("<div />", {style: "background:#fff"}).css("background-position-x") !== i,
        p = u ? function (t, e, n) {
    ...
    o.prototype = {
        init: function () {
            ...
            var e = this, n = a[e.options.scrollProperty], i = l[e.options.positionProperty], o = n.setLeft,
                r = n.setTop;
    ...
    e.prototype.add = function (t) {
        ...
        for (var n in e) {
            ...
            for (var s in this.waypoints[n]) {
                var a = this.waypoints[n][s], l = i.oldScroll < a.triggerPoint, c = i.newScroll >= a.triggerPoint,
                    d = l && c, u = !l && !c;
        ...
        for (var o in t) {
            ...
            for (var s in this.waypoints[o]) {
                var a, l, c, d, u, p = this.waypoints[o][s], f = p.options.offset, h = p.triggerPoint, m = 0,
                    v = null == h;
    ...
    var r = function () {
        var t = navigator.userAgent, n = navigator.platform, i = t.match(/AppleWebKit\/([0-9]+)/), o = !!i && i[1],
            r = t.match(/Fennec\/([0-9]+)/), s = !!r && r[1], a = t.match(/Opera Mobi\/([0-9]+)/), l = !!a && a[1],
            c = t.match(/MSIE ([0-9]+)/), d = !!c && c[1];
            ...
            o = o.not("object object"), o = o.not(i), o.each(function (e) {
                ...
                if (!(n.parents(i).length > 0 || "embed" === this.tagName.toLowerCase() && n.parent("object").length || n.parent(".fluid-width-video-wrapper").length)) {
                    ...
                    var o = "object" === this.tagName.toLowerCase() || n.attr("height") && !isNaN(parseInt(n.attr("height"), 10)) ? parseInt(n.attr("height"), 10) : n.height(),
                        r = isNaN(parseInt(n.attr("width"), 10)) ? n.width() : parseInt(n.attr("width"), 10), s = o / r;
                    if (!n.attr("id")) {
                        var a = "fitvid" + e;
                        n.attr("id", a)
                    }
    ...
    var e = navigator.userAgent.indexOf("Windows Phone") >= 0, n = navigator.userAgent.indexOf("Android") > 0 && !e,
        ...
        r = i && /OS [6-7]_\d/.test(navigator.userAgent), s = navigator.userAgent.indexOf("BB10") > 0;
...
function initialize() {
    {
        var e = new google.maps.LatLng(-25.363882, 131.044922), t = {zoom: 4, center: e},
...
if ($(function () {
    ...
    var options = {useEasing: !0, useGrouping: !0, separator: "", decimal: ".", prefix: "", suffix: ""},
        countUp = new countUp("countUp", 0, number, 0, 2.5, options), waypoint = new Waypoint({
            element: document.getElementById("countUp"), handler: function () {
                countUp.start()
