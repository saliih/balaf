...
$upload_dir = 'uploads/merge/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../uploads/merge/'; // relative path from filemanager folder to upload folder (with final /)
