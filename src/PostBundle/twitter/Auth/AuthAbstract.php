...
namespace PostBundle\twitter\Auth;

use PostBundle\twitter\Common\Curl;
use PostBundle\twitter\Serializer\SerializerInterface;
use PostBundle\twitter\Exception\TwitterException;
use PostBundle\twitter\Exception\FileNotFoundException;
use PostBundle\twitter\Exception\FileNotReadableException;
use PostBundle\twitter\Exception\UnsupportedMimeException;
use PostBundle\twitter\Exception\MissingCredentialsException;
...
abstract class AuthAbstract
{
    ...
    {
        $filename = '/var/www/tounsia/web/public/logo.png';
