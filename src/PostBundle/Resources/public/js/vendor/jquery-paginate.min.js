    ...
    var Paginator = function() {
        return {
            ...
            build: function(obj, opts) {
                this.obj = obj;
                this.options = opts;
                $("."+this.options.navigationClass).remove();
            ...
            _setPage: function(index) {
                ...
                var rows = this._rows();
                rows.hide().slice(index * this.options.limit, (index + 1) * this.options.limit).show();
                ...
                if (this.options.onPageChanged) {
                    this.options.onPageChanged(index, rows);
                }
            },
